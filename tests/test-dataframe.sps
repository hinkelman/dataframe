...
(test-assert (dataframe-equal?
              dfc
              (dataframe-crossing '(col1 a b) '(col2 c d))))
(test-assert (dataframe-equal?
              dfc
              (dataframe-crossing '(col1 a b) (make-dataframe '((col2 c d))))))
(test-assert (dataframe-equal?
              dfc
              (dataframe-crossing (make-dataframe '((col1 a b)))
...
(test-assert (dataframe-equal? (make-dataframe '((b 5 6) (c 8 9)))
...
(test-assert (dataframe-equal?
              df17
              (rowtable->dataframe '((a b c) (100 4 700) (300 6 900)) #t)))
(test-assert (dataframe-equal? df19 (rowtable->dataframe '((c) (1) (2) (3)) #t)))
(test-assert (dataframe-equal?
              (make-dataframe '((V0 1 2) (V1 3 4)))
...
(test-assert (dataframe-equal?
              (make-dataframe '((adult 1 3 5) (juv 10 30 50)))
